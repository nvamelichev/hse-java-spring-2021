...
| Александр Латышев, <br> Искандер Ямбулатов, <br> Максим Минченок | 1. Консольный органайзер | Четвёртый релиз до **21.05**: https://github.com/hypersousage/console-organizer/issues/7 | [console-organizer](https://github.com/hypersousage/console-organizer) |
