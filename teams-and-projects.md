...
| Петр Молодык, <br> Данила Седашов, <br> Екатерина Булатова, <br> Наталья Денисенко | **\*** Мод для Minecraft | Улучшения проектной документации до 10.03	 (поскольку повышенный уровень сложности и был MVP &mdash; дедлайн был продлён) | [Minecraft Mod](https://github.com/pmolodyk/MinecraftFabricMod) |
...
- **Модель предметной области:** soft deadline 12.03, hard deadline 19.03. Варианты представления модели:
  ...
  - Более подробная ОО-модель системы, одно из:
    - [**рекомендуется**] UML-диаграммы (Use Cases, Class, Sequence и/или Statechart) или [ECore](https://www.eclipse.org/ecoretools/overview.html), плюс краткий поясняющий текст, если необходимо. Подойдёт любой редактор (ArgoUML, Violet, dia, MS Visio, ...)
