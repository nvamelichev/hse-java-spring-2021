...
| Сабина Даянова, <br> Дарья Барановская, <br> Юлия Кошелева | 3. Экстрактор текста | Улучшения проектной документации до 05.03 | [text-extractor](https://github.com/sabinadayanova/text-extractor) |
...
| Константин Матвеев, <br> Андрей Ветров, <br> Тимур Ваньков | 5. Статистика по исходному коду на C-like языках программирования | Улучшения проектной документации до 05.03 | [code-statistics](https://github.com/vetand/code-statistics) |
| Борис Шошин, <br> Илья Зюляев | 10. Карточки-запоминалки (Flash Cards) | Проектная документация до 26.02 | [flash-cards] (https://github.com/ilya2204/flash-cards) |
