...
| Александр Латышев <br> Павел Круглов <br> Искандер Ямбулатов| ??? | Выбрать проект до 24.02 |
| Елена Семерова <br> Константин Еленик <br> Борис Шошин | ??? | Выбрать проект до 24.02 |
| Константин Матвеев <br> Андрей Ветров | 5. Статистика по исходному коду на C-like языках программирования | Проектная документация до 26.02 |
